    ...
    <section className="relative h-[70vh] md:h-[85vh] w-full overflow-hidden">
      ...
      <div className="relative h-full container mx-auto px-4 flex items-center justify-center md:justify-start">
        <div className="max-w-2xl text-white text-center md:text-left">
          ...
          <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8 font-light tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 items-center justify-center md:justify-start">
            ...
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-foreground w-full sm:w-auto">
              Comprar Hombre
            </Button>
          </div>
        </div>
